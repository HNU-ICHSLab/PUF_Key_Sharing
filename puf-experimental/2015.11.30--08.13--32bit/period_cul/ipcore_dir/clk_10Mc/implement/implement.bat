...
xst -ifn xst.scr
move clk_10Mc_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_10Mc_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_10Mc_exdes.ucf clk_10Mc_exdes

echo 'Running map'
map -timing -pr b clk_10Mc_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_10Mc_exdes -w routed.ncd routed.vhd
cd ..
